...
product_keys = {'COCA': 'coca', 'AGUA': 'agua', 'GUARANA':'guarana', 'SUCO MARACUJA': 'suco_maracuja', 'SUCO PESSEGO': 'suco_pessego', 'SUCO MANGA': 'suco_manga', 'CHOPP': 'chopp', 'VINHO':'vinho', 'GUARAVITA':'guaravita'}
...
with st.expander(expanded=True, label='Registro de Vendas'):
    ...
    st.dataframe(df_sales, use_container_width=True, height=200,
                 column_config={
                     ...
                     'suco_manga': st.column_config.NumberColumn('SUCO MANGA'), # Novo campo
